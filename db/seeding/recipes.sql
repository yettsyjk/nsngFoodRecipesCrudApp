...
INSERT INTO public."recipes" ("title", "author", "description", "category_type", "ingredients", "photo") VALUES
 (
    ...
    (
        ...
        'Juanita Ortiz', 
        'Combine beef, egg, onion, milk and almond flour. Season with salt and pepper. Form into a loaf and place into baking dish. Pour mustard, and tomato mixture over loaf. Bake at 350 degrees for 1 hour.', 
        3,
        '{"1 1/2 pounds ground beef","1 egg","1 onion",chopped,"1 cup milk","1 cup almond flour","salt and pepper to taste","2 tablespoons brown sugar","2 tablespoons prepared mustard","1/3 cup tomotoes"}',
        'https://media.giphy.com/media/zG1Ahac9UHcIw/giphy.gif'
    ),
    (
        'Chicken Fancesca', 
        'Tommy Bahama', 
        'Evenly coat milk-soaked chicken in mix of almond flour, pecorino romano cheese, and parsley. Cook in large skillet until lightly browned. Bake in oven for 25 minutes.', 
        4,
        '{"4 large skinless","boneless chicken breast halves","1 cup milk","or as needed","1 cup almond flour","1 cup grated Pecorino Romano cheese","2 tablespoons chopped fresh parsley","1 cup olive oil","salt and ground black pepper to taste","1 lemon","thinly sliced","1 cup white wine","1 cup chicken broth","1/4 cup lemon juice","1 ounce brandy-based orange liqueur (such as Grand Marnier®)","or to taste"}',
